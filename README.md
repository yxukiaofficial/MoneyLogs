...
# Contributor
> Big thanks to `vxngexnce` who helped me dealing with the SQL stuff. This script cannot be done without you!
...
1. Download the file
2. Unzipped the file
3. Drag and drop [MoneyLogs] to your server folder
